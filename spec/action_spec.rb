...
RSpec.describe Action, "Action model" do
  ...
  describe "from_location_coordinates" do
    ...
    context "If location coordinates seem to be moving around a lot and then stop for 15+ minutes" do
      ...
      travelling_location_coordinates << LocationCoordinates.new(user_id: 1, time_visited: (original_datetime + 5.minutes), lat: 11, lng: 20)
      travelling_location_coordinates << LocationCoordinates.new(user_id: 1, time_visited: (original_datetime + 10.minutes), lat: 12, lng: 20)
      # Stationary ones
      visiting_location_coordinates = []
      visiting_location_coordinates << LocationCoordinates.new(user_id: 1, time_visited: (original_datetime + 15.minutes), lat: 10.0000001, lng: 20)
      visiting_location_coordinates << LocationCoordinates.new(user_id: 1, time_visited: (original_datetime + 20.minutes), lat: 10.00000012, lng: 20)
      visiting_location_coordinates << LocationCoordinates.new(user_id: 1, time_visited: (original_datetime + 25.minutes), lat: 10.00000013, lng: 20)
